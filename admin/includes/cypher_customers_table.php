<div id="dataTable-container">
    <table id="cypher-dataTable" class="display">
        ...
        $sql = "SELECT 
                ...
                WHERE UserLogin.UserNumber = Customers.CustomersID
        ...
        while ($row = mysql_fetch_array($rs)) {
            ...
            echo "<td>$row[1]</td>";
            echo "<td width='24'><a href='index.php?pg=customers&p=u&rec=$row[0]'>Update</a></td>";
            echo "<td width='24'><a onclick=\"deleteRow(this);\">Delete</a></td>";
            echo "<td width='18'><a href='index.php?pg=customers&p=v&rec=$row[0]'>View</a></td>";
            echo "</tr>";
        }
        ?>
    </table>
