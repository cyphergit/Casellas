...
//    var page = $(".hidden-pg").text();
//
//    this.init_mobileResolution = function () {
//        var container = $(".main-body").width();
//        $('.con-width').text(container);
//    };
//
//    this.init_mobileDetect = function () {
//        //initiate as false
//        var isMobile = false;
//        // device detection
...
//        var decodeRef = atob(capRef);
//        return decodeRef;
//    };

//    this.init_currentPageHighlight = function () {
//        $('.navbar-nav li a').each(function () {
//            var linkText = $(this).attr('id');
//            if (linkText === page) { $(this).css({'text-shadow': '1px 0px 20px #fff'});}
//        });
//
//        var buttonSection = $('.cypher-button-section');
//        switch (page) {
//            case 'contact':
//                buttonSection.hide();
//                break;
...
//    this.navMobileToggle = function () {
//        $(".navbar-inverse .navbar-toggle").click(function () {
//            $(this).data('clicked', true);
//            if ($('.navbar-toggle').data('clicked')) {
//                $(this).css({'background-color': '#096ac9'});
//            }
//        });
//    };
    ...
    this.loadAll = function () {
        //this.init_mobileDetect();
        //this.init_mobileResolution();
        this.init_navigation();
        //this.init_currentPageHighlight();
        //this.init_backToTop();
        //this.captchaEncode();
    };
};